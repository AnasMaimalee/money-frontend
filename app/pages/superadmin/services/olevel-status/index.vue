...
const handleReject = async () => {
  ...
  rejectLoading.value = true // ✅ SHOW REJECT LOADER
  ...
  try {
    ...
    rejectLoading.value = false // ✅ HIDE REJECT LOADER
  }
}

/* ✅ UNIVERSAL FILE DOWNLOAD (PDF + IMAGES) */
const downloadFile = async (filePath: string, filename = 'jamb-upload-status') => {
  if (!filePath) {
...
const columns = [
  ...
  { title: 'Is Paid?', dataIndex: 'is_paid', width: 100, slots: { customRender: 'isPaidCell' } }, // ✅ NEW COLUMN
